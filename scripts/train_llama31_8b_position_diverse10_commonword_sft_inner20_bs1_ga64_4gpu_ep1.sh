...
CONFIG_FILE="${CONFIG_FILE:-configs/training/llama3.1_8b_position_diverse10_commonword_sft_inner20_bs1_ga64_4gpu_ep1.yaml}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/secalign_runs/llama31_8b_position_diverse10_commonword_sft_inner20_bs1_ga64_4gpu_epoch1}"
LOG_DIR="${LOG_DIR:-$ROOT_DIR/position_diverse10_commonword_8b_train_outputs}"
...
echo "Launching Llama-3.1-8B position-diverse SFT-attacker training"
...
echo "Finished Llama-3.1-8B position-diverse SFT-attacker training."
echo "Log: $LOG_FILE"

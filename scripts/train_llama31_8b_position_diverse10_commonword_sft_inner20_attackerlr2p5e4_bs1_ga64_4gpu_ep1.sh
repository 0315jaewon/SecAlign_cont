...
CONFIG_FILE="${CONFIG_FILE:-configs/training/llama3.1_8b_position_diverse10_commonword_sft_inner20_attackerlr2p5e4_bs1_ga64_4gpu_ep1.yaml}"
CACHE_DIR="${CACHE_DIR:-/home/jaewonc/models/Meta-Llama-3.1-8B-Instruct}"
DATA_FILE="${DATA_FILE:-$ROOT_DIR/data/preference_Llama-3.1-8B-Instruct_dpo_NaiveCompletion_randpos_synthetic_alpaca.json}"
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/secalign_runs/llama31_8b_position_diverse10_commonword_sft_inner20_attackerlr2p5e4_bs1_ga64_4gpu_epoch1}"
LOG_DIR="${LOG_DIR:-$ROOT_DIR/position_diverse10_commonword_8b_inner20_attackerlr2p5e4_train_outputs}"
...
LR="${LR:-0.00016}"
ATTACKER_LR="${ATTACKER_LR:-0.00025}"
...
echo "Launching Llama-3.1-8B position-diverse SFT-attacker training, inner20 attacker_lr=2.5e-4"
...
echo "Finished Llama-3.1-8B position-diverse SFT-attacker inner20 attacker_lr=2.5e-4 training."
echo "Log: $LOG_FILE"

...
CONFIG_FILE="${CONFIG_FILE:-configs/training/llama3.1_8b_injection_at_end_commonword_sft_inner10_bs1_ga64_4gpu_ep1.yaml}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/secalign_runs/llama31_8b_injection_at_end_commonword_sft_inner10_bs1_ga64_4gpu_epoch1}"
LOG_DIR="${LOG_DIR:-$ROOT_DIR/injection_at_end_commonword_8b_inner10_train_outputs}"
...
echo "Launching Llama-3.1-8B injection-at-end SFT-attacker training, inner10"
...
echo "Finished Llama-3.1-8B injection-at-end SFT-attacker inner10 training."
echo "Log: $LOG_FILE"
